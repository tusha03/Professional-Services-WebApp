...
<body class="sub_page">
    ...
    <section class="about_section layout_padding">
        <div class="container">
            <div class="row">
				<h3>Disapproved Service Providers</h3>
                <table class="table table-striped">
                    ...
                    for(ServiceProvider service : serviceProviders)
                    {
                    	...
                    	if(service.getSerStatus().equals("Disapproved"))
                    	{i++;
                    	%>
                    	 <tr>
                            <th scope="row"><%=i %></th>
                            <td><%=service.getSerName() %></td>
                            <td><%=service.getSerCont() %></td>
                            <td><a href="disapprove-detail/<%=service.getSerCont()%>">Details</a></td>
                            <td><a href="approvedis/<%=service.getSerCont()%>">Approve</a></td>
                            <td><a href="delete/<%=service.getSerCont()%>">Delete</a></td>
                        </tr>
                    	<%
                    	}
                    }%>
