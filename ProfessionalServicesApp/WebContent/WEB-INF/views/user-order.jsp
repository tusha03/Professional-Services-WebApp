...
<head>
    <style>
        ...
        form.order-form {
            ...
            border-radius: 5px;
            margin-top: 20px;
            /* Add top margin to create space between h2 and form */
        }
        ...
        /* Style for input fields inside the form */
        form.order-form input[type="date"],
        form.order-form input[type="time"],
        form.order-form input[type="submit"] {
            width: calc(100% - 22px);
            /* Adjust input width to account for padding and border */
            padding: 10px;
            margin-bottom: 15px;
            border: 1px solid #ccc;
            border-radius: 5px;
...
<body class="sub_page">
    ...
    <section class="about_section layout_padding">
		...
		<%String cat = (String) request.getAttribute("category"); %>
                <h2 class="special-heading">Service : <%=cat%></h2>


                <form class="order-form" action="placeOrder" method="post">
