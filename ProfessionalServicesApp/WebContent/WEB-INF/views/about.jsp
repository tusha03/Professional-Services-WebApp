      ...
      <div class="header_bottom">
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand " href="index">  Professional Services</a>
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="service-provider-login">Service Provider</a>
                    <a class="dropdown-item" href="user-login">Customer</a>
                  </div>
                </li>                <form class="form-inline justify-content-center">
