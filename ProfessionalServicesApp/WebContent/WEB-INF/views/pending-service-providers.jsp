...
<head>
    ...
    <title>Pending Service Provider</title>
            ...
            <div class="row">				 
                ...
                <table class="table table-striped">
                    ...
                    for(ServiceProvider service : serviceProviders)
                    {
                    	...
                    	if(service.getSerStatus().equals("Pending"))
                    	{i++;
                    	%>
                    	 <tr>
                            <th scope="row"><%=i %></th>
                            ...
                            <td><a href="pending-detail/<%=service.getSerCont()%>">Details</a></td>
                            <td><a href="approve/<%=service.getSerCont()%>">Approve</a></td>
                        </tr>
                    	<%
                    	}
                    }%>
